...
-(void)testFileModification{
	...
	STAssertTrue([manager isModified:TEST_RESOURCE anotherResource:[_testResources objectAtIndex:0]], @"Must be different");
	STAssertFalse([manager isModified:TEST_RESOURCE anotherResource:[_testResources objectAtIndex:1]], @"Must be equal");
	STAssertTrue([manager isModified:TEST_RESOURCE anotherResource:[_testResources objectAtIndex:2]], @"Must be different");
}

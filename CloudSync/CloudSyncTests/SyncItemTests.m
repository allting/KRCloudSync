...
-(void)testSyncItemCreate{
	...
	STAssertEquals(KRSyncItemDirectionNone, syncItem.direction, @"Must be equal to direction of syncItem");
}
...
-(void)testSyncItemWithResources{
	...
	KRSyncItem* syncItem = [[KRSyncItem alloc]initWithResources:localResource remoteResource:remoteResource comparisonResult:result];
	STAssertEquals(KRSyncItemDirectionNone, syncItem.direction, @"Must be equal to direction of syncItem");
}
